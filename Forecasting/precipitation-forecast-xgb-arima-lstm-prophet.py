...
def visualize_results(train, test, models, future):
        ...
        ax6.set_title('Prophet: 2026 - 2027 Precipitation Forecast')
        plt.legend(fontsize='x-small', loc='upper left')
        
        plt.suptitle('Caribbean Region Precipitation Forecast for the next 2 years')
...
def main():
    ...
    """Main execution"""
    print("=" * 80)
    print("TIME SERIES FORECASTING - Caribbean Precipitation")
    print("=" * 80)
